...
Local $SourceFile = "S:\Bin\Lucidity_Win32_Full\Lucidity.dll"
Local $DestFile   = "S:\Installer\Vst32 Dir\Lucidity.dll"
FileCopy($SourceFile, $DestFile, 1);

Local $SourceFile = "S:\Bin\Lucidity_Win64_Full\Lucidity.dll"
Local $DestFile   = "S:\Installer\Vst64 Dir\Lucidity.dll"
FileCopy($SourceFile, $DestFile, 1);
