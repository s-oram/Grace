      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if not assigned(AClass) then
              raise Exception.Create(sxrUnregisteredClassType + ' ' + AComponentNode.Name);
...
procedure TsdXmlObjectReader.ReadProperty(ANode: TXmlNode;  AObject: TObject; AParent: TComponent; PropInfo: PPropInfo);
var
  PropType: PTypeInfo;
  AChildNode: TXmlNode;
  Method: TMethod;
