...
procedure TModSystemFrame.ProcessZeroObjectMessage(MsgID: cardinal; Data: Pointer; DataB:IZeroMessageData);
var
  s : string;
begin
  if MsgID = TLucidMsgID.SampleFocusChanged_OLD       then UpdateModulation;
