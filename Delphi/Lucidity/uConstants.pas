...
type
  ...
  const
    ...
    CheckForSampleFocusChange        = 2; // An action might have caused the sample focus to change. Check and update.
    MouseOverSampleRegionChanged     = 3;
    SampleRegionChanged              = 4; //sent when something about a region has changed. ie. the region has moved.
    MidiKeyChanged                   = 5;
    PreviewInfoChanged               = 6;
    SampleMarkersChanged             = 7;
    SampleOscTypeChanged             = 8;
    LoopTypeChanged                  = 9;
    SampleDirectoriesChanged         = 10;
    FilterChanged                    = 11;
    ModSlotChanged                   = 12;
    LfoChanged                       = 13;
    ModAmountChanged                 = 14;
