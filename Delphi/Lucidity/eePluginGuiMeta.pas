...
begin
  ...
  Plugin.Globals.MotherShip.RegisterZeroObject(ScopeHandler, TZeroObjectRank.zoMain);
  ...
  aPlugin.Globals.MotherShip.RegisterZeroObject(ActiveModDetector, TZeroObjectRank.zoMain);
end;
