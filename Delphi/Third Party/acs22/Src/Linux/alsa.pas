...
//  snd_async_add_pcm_handler_t = function(var handler:Psnd_async_handler_t; pcm:Psnd_pcm_t; callback:snd_async_callback_t; private_data:pointer):longint;cdecl;
  ...
  snd_pcm_dump_t = function(pcm:Psnd_pcm_t; out:Psnd_output_t):longint;cdecl;
  snd_pcm_dump_hw_setup_t = function(pcm:Psnd_pcm_t; out:Psnd_output_t):longint;cdecl;
  snd_pcm_dump_sw_setup_t = function(pcm:Psnd_pcm_t; out:Psnd_output_t):longint;cdecl;
  snd_pcm_dump_setup_t = function(pcm:Psnd_pcm_t; out:Psnd_output_t):longint;cdecl;
  snd_pcm_hw_params_dump_t = function(params:Psnd_pcm_hw_params_t; out:Psnd_output_t):longint;cdecl;
  snd_pcm_sw_params_dump_t = function(params:Psnd_pcm_sw_params_t; out:Psnd_output_t):longint;cdecl;
  snd_pcm_status_dump_t = function(status:Psnd_pcm_status_t; out:Psnd_output_t):longint;cdecl;
    {
...
initialization
  ...
  Libhandle := dlopen(asoundlib_path, RTLD_NOW or RTLD_GLOBAL);
