Cubase VST SDK for Delphi v2.4.3
================================ 4 May 2010
...
Changes
-------
  + version 2.4.3  (04-05-2010)
    - removed all "packed" modifiers for records
    - set alignment to 8 for 64bit and to 1 for 32bit
    - 64bit compiler define is set automatically depending on compiler specific defines
