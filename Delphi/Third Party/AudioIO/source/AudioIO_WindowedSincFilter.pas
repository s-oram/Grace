unit AudioIO_WindowedSincFilter;
...
type
  ...
  public
    ...
    procedure Process(In1,Out1 : PSingle; const SampleFrames : integer);
  end;

implementation

uses
  //DelphiPlot,  eeDsp, eeDspWindows,
  AudioIO_DSP;
...
procedure TWindowedSincFilter.Process(In1,Out1: PSingle; const SampleFrames: integer);
var
  tpx : PSingle;
