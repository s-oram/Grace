{ unit NativeXml
  ...
  - BXM allows external encryption/compression thru event handlers. AES encryption
    is handled in functions TNativeXml.AeszEncode and TNativeXml.AeszDecode.
...

{
  ...
  public
    ...
    //
    procedure LoadFromURL(const URL: Utf8String); virtual;
...
begin
// NH: linux equivalent?
  DoDebugOut(Self, wsFail, 'not implemented in linux');
end;
{$endif USEWINDOWS}
